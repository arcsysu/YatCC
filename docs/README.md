...
YatCC 是中山大学编译的实验框架。基于 YatCC 编译实践体系，中山大学[计算机学院](https://cse.sysu.edu.cn/)与[国家超算广州中心](http://www.nscc-gz.cn/)联合开发了智能编译教学实践平台 [YatCC-AI](https://yatcc-ai.com)（Yat Compiler Construction with AI）。YatCC-AI 结合国产超算资源与 DeepSeek 等大模型，为《编译原理》和《编译器构造实验》课程提供全新的智能化学习体验。平台深度融合高性能计算（HPC）和人工智能（AI）技术，通过云端容器化环境、AI辅助开发和实时反馈机制，全面优化实践环节，帮助学生掌握编译领域核心知识，接触前沿编译技术与实际应用场景，从而提升工程实践能力与科研创新能力。
