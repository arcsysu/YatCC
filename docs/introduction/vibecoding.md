...
上图是一个简单的示例，让kimi对我实验1的代码进行了CodeReview，他会给出代码功能、代码规范性、和修改的建议，可以帮助提高代码的规范性。
...
在这个mindset下，你应该要提供给他更为详细的信息，而不是直接甩给它一个空洞的任务概要。以代码生成任务为例，一个良好的promt应该包含几个要素：
...
![How to create skills](../images/vibecoding/how_to_create_skills.png ':size=500')
