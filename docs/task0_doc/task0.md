# 实验内容
实验 0 存在的目的是保证每一位同学都已经配置好了实验环境并且学会了使用实验框架，并且获得使用大语言模型来辅助代码开发环境的第一手体验。，<u>在本次编译课程实验中，我们助教团队提供了 DeepSeek-R1</u>，供大家使用。
...
<img src="../images/task0/code_gen_select.jpg" alt="选中函数添加进入上下文中" width="40%" />
...
<img src="../images/task0/code_gen_prompt.jpg" alt="输入提示词以指示大语言模型进行代码生成" width="80%"/>
...
<img src="../images/task0/code_gen_diff.jpg" alt="插件根据大语言模型的回复对源代码文件进行修改"/>
...
<img src="../images/task0/code_gen_revert.jpg" alt="将误删的代码内容恢复" width="80%"/>
